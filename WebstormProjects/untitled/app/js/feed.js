...
.controller('Feed', ['$scope', '$location', '$http', '$cookies', '$cookieStore', '$rootScope', 'dataService', function($scope, $location, $http, $cookies, $cookieStore, $rootScope, dataService) {
    ...
    $scope.post = function(formData) {
        ...
        $http.post('http://siph.io/cloud/post', {
            ...
            console.log("postID ".concat(response.data.postID));
